...
get_attribute_location(program::Program, args...) = get_attribute_location(program.id, args...)
...
function get_attribute_location(program::GLuint, name::String)
    ...
    if location == -1
        @warn "Named attribute (:$(name)) is not an active attribute in the specified program object or\n
